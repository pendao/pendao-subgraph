...
export class PenStaking__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PenStaking__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class PenStaking extends ethereum.SmartContract {
  static bind(address: Address): PenStaking {
    return new PenStaking("PenStaking", address);
  }
  ...
  epoch(): PenStaking__epochResult {
    ...
    return new PenStaking__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<PenStaking__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint256,uint256)",
      []
  ...
  sPEN(): Address {
    let result = super.call("sPEN", "sPEN():(address)", []);

    return result[0].toAddress();
  }

  try_sPEN(): ethereum.CallResult<Address> {
    let result = super.tryCall("sPEN", "sPEN():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  warmupInfo(param0: Address): PenStaking__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new PenStaking__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<PenStaking__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PenStaking__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
